...
>
> **状态说明（2026-07-15）**：当前项目进度以 `docs/CURRENT_STATUS.md` 和 `docs/PROGRESS.md` 为准。本文继续作为修复记录和遗留问题清单；其中 R0.1-R1.3 已按下文记录修复并新增回归测试。
...
>
> **修复状态（2026-07-05）**：R0.1-R1.3 已按本节验收语义重新修复；新增回归测试后 `pytest` 252 项通过。本次修改涉及的核心文件 Ruff 通过。全仓历史 Ruff/mypy 债务仍需单独清理。
